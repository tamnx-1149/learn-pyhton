...
SECRET_KEY = 'django-insecure-vh2vzbxnb_h-ydk_i73+^ieu%)dzo&5j9&dy17(!s#i5g)(*im'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv("DB_HOST", "localhost"),  # Default DB host
        'PORT': os.getenv("DB_PORT", "3306"),  # Default DB port
    }
}
